...
def _add_railway_u_girder_uls_framework_section(
    ...
    document.add_paragraph(
        ...
        "code-basis guardrails, flexure evidence, PSC shear route evidence, torsion / V+T guard evidence, and a check-readiness matrix. It is not final code-certified design "
