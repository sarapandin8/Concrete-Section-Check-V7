...
See `docs/design/qa_baseline1.md`, `docs/design/workflow_status1.md`, `docs/design/status_colpier1.md`, `docs/design/status_colpier2.md`, and `docs/design/state_section1.md` for milestone scope and QA gate notes.
