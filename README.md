...
See `docs/design/qa_baseline1.md`, `docs/design/workflow_status1.md`, `docs/design/status_colpier1.md`, and `docs/design/status_colpier2.md` for milestone scope and QA gate notes.
